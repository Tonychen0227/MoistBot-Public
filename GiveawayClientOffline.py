...
class GiveawayClient:
    ...
    def log(self, log_string):
        ...
        timestamp = datetime.fromtimestamp(timestamp_epoch_s).strftime('%Y-%m-%d %H:%M:%S')
        print(f"{timestamp}: {log_string}", flush=True)
    ...
    def do_giveaway(self):
        ...
        self.strategy = OfflineStrategy(self)
